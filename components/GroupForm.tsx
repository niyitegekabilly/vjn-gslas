...
export const GroupForm: React.FC<GroupFormProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      {/* Sticky Header */}
      <div className="flex-none p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
        <h2 className="text-xl font-bold text-gray-800">{title || labels.createGroupTitle}</h2>
        <button onClick={onCancel} className="text-gray-400 hover:text-gray-600 transition-colors"><X size={24} /></button>
      </div>
      ...
      {/* Sticky Footer */}
      <div className="flex-none p-4 border-t border-gray-100 bg-gray-50 flex gap-4">
        <button 
          type="button" 
          onClick={onCancel} 
        ...
        <button 
          ...
          className="flex-1 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 flex justify-center items-center font-bold shadow-md transition-colors disabled:opacity-50"
        >
